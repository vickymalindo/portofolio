    ...
    <section className="lg:min-h-screen text-center">
      ...
      <nav className="py-5 mb-2 lg:mb-12 flex items-center justify-between p-4">
        ...
        <ul className="">
          <li>
            <a
              href="https://drive.google.com/file/d/1aJW51g_-TPZUCnnIY7w8iG7DU0fXs_oZ/view?usp=sharing"
              target="_blank"
            >
              <motion.button
                initial={{ opacity: 0 }}
      ...
      <div className="py-24 p-4">
        ...
        >
          Vicky Malindo Andreas Putrawan
        </motion.h2>
        <motion.h3
          initial={{ y: 10, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
        ...
        >
          A writer to translating design into a product. The person who love{' '}
          <span className="text-primary font-medium">code</span> &{' '}
          <span className="text-primary font-medium">coffee</span>.
        </motion.p>
        {/* Social Media */}
